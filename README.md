...
A Muck-inspired survival roguelike you can play with a friend straight from a link. Wash ashore
...
- **Game source:** [`driftwood/`](driftwood/) — vanilla JS + Canvas, zero assets (all pixel art & sound are procedural), no build step.
...
| Key | Action |
|---|---|
| **WASD** / arrows | move · **Shift** sprint (stamina) |
| **Space** | dodge roll (i-frames; extra charges from Feathers) |
| **LMB** | attack / chop / mine / place the held building piece |
...
| **Q** | quick-eat the best food you carry |
...
driftwood/
  ...
  js/render.js    camera, chunked terrain cache, y-sorted sprites, lighting, particles, minimap
  js/audio.js     WebAudio synthesised SFX and ambient
  js/input.js     keyboard/mouse → input packets & discrete actions
